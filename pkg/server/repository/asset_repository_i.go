...
type AssetRepositoryI interface {
	...
	FetchAssetsByOwner(ctx context.Context, transactionId TransactionId, namespace string, ownerPublicKey string, pagination PaginationOption[model_server.NodeDbId]) ([]model_server.Asset, error)
